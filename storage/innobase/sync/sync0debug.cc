	...
	UNIV_NOTHROW
{
	...
	LATCH_ADD_RWLOCK(XTRA_DATAFILES_ITER_MUTEX, SYNC_MUTEX, PFS_NOT_INSTRUMENTED);

	LATCH_ADD_RWLOCK(XTRA_COUNT_MUTEX, SYNC_MUTEX, PFS_NOT_INSTRUMENTED);

	LATCH_ADD_RWLOCK(XTRA_DATADIR_ITER_T_MUTEX, SYNC_MUTEX, PFS_NOT_INSTRUMENTED);
