...
MACRO(GET_XTRABACKUP_VERSION)
  ...
  IF(NOT XB_MAJOR_VERSION OR NOT XB_MINOR_VERSION OR "${XB_PATCH_VERSION}" STREQUAL "")
    MESSAGE(FATAL_ERROR "XB_VERSION file cannot be parsed.")
  ENDIF()

  SET(XB_VERSION "${XB_MAJOR_VERSION}.${XB_MINOR_VERSION}.${XB_PATCH_VERSION}${XB_EXTRA_VERSION}")
  MESSAGE(STATUS "Percona XtraBackup ${XB_VERSION} (based on MySQL ${VERSION} codebase)")
  SET(XB_BASE_VERSION "${XB_MAJOR_VERSION}.${XB_MINOR_VERSION}.${XB_PATCH_VERSION}" CACHE INTERNAL "XtraBackup Base version")
  ...
  IF (EXISTS ${CMAKE_SOURCE_DIR}/.bzr)
    EXECUTE_PROCESS(
      COMMAND ${BZR_EXECUTABLE} version-info --custom --template "{revno}" ${CMAKE_SOURCE_DIR}
